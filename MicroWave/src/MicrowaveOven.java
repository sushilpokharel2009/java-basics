...
public class MicrowaveOven extends JFrame 
{
   ...
   // Time instance for storing the current time
    CookingTime microwaveTime = new CookingTime();
   ...
   private void createUserInterface()
   {
      ...
      windowJPanel.setBackground(Color.BLUE);
      ...
      controlJPanel.setBackground(Color.RED);
      ...
      displayJTextField.setText(getTitle());;
